...
- **入口は説明のない絵**（佐藤卓「魅力的な分からなさ」）。渦巻きの線、列に並ぶ黒、丸と黒、急に白くなる、同じ数・ちがう葉……。「何が見える？」だけがある。いじると絵の中の数が動く
- **「分かったかも」は自己申告**。押すと聞かれるのは「いま、何がしたい？」——もっと試す／自分で作る／誰かに見せる（説明なしで絵だけ渡す）／地図に書く。理解は終点でなく起点
- **課題も順番もない**。おもちゃ（数の表・分ける・約数・レース・世界を作る・予想を試す機械）を好きにいじる
